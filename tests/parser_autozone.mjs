...
test('autozone', async (_t) => {
  const params = {
    ...
    vin: '1PTSR21P75EA53447', // 1FTSW21P75EA53447 (OK), fdfgdfgdfgdfhddfsdgdfhdfhdfhdf (invalid), 1PTSR21P75EA53447 (not found)
    zip: '98264', // 1234 (invalid), 98264 (OK), 33333 (not found)
    // with subcategories
    // partNumber: 'H13XV'
    // single product
    // partNumber: 'S2XL'
    partNumber: 'S9549XL' // S9549XL (OK), yufkuyfkuf (not found), AL9432X (OK)
  };
  try {
